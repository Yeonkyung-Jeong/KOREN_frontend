...
export const mockApiService = {
    ...
    const mockSummaries = [
      {
        ...
        "환자의 우려점": "최근 크기가 커지고 색깔이 변한 점에 대한 우려 표현",
        "진료 계획": "조직검사를 통한 정확한 진단 후 치료 방향 결정",
        처방: "항염제 연고 처방, 2주 후 재진료 예약",
      },
      {
        "의사 소견": "양성 병변으로 추정되나 경계 관찰 필요",
        "환자의 우려점": "가족력으로 인한 불안감 및 재발 가능성 문의",
        "진료 계획": "정기적 경과 관찰 및 자가 점검 교육",
        처방: "보습제 사용, 자외선 차단 권고",
      },
      {
        "의사 소견": "염증성 피부 질환으로 보이며 감염 소견 없음",
        "환자의 우려점": "업무상 스트레스와 피부 상태 악화의 연관성 문의",
        "진료 계획": "생활습관 개선 및 스트레스 관리 상담",
  ...
  async getLatestSummary(patientId: string): Promise<{
    ...
    const defaultSummary: CommunicationSummary = {
      "의사 소견": "정기 검진에서 확인된 일반적인 피부 소견",
      "환자의 우려점": "전반적인 피부 건강 상태에 대한 문의",
      "진료 계획": "정기적 경과 관찰 및 건강 관리",
      처방: "일반적인 피부 관리 지침 제공",
    };
